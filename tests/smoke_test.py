...
check(
    "resolve_location('Ninoy Aquino Intl')",
    resolve_location("Ninoy Aquino Intl"),
    "MNL",
)
check(
    "resolve_location('Charles de Gaulle')",
    resolve_location("Charles de Gaulle"),
    "CDG",
)
...
check(
    "resolve_airline('Ethiopian Airlines')", resolve_airline("Ethiopian Airlines"), "ET"
)
...
section(
    "3. Slot filler  (needs: pip install spacy && python -m spacy download en_core_web_sm)"
)
