...
parser.add_argument("--delay",    type=float, default=13.0,      help="Seconds between requests (default 13 = 5/min)")
parser.add_argument("--language", default=None,                  help="Language hint: 'en' or 'fr' (optional)")
parser.add_argument("--ext",      default="m4a,wav,mp3,ogg",     help="Comma-separated audio extensions to include")
